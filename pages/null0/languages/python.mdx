...
<Callout emoji='🐍'>Python is a fun & simple language, that is very easy to prototype ideas with. Normally, it's interpreted which adds some cart-size, but we compile to minimal wasm.</Callout>
