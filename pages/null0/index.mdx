...
- `Image` - this is a reference to a loaded image-object in the host, and is a `u32`.
- `Font` - this is a reference to a loaded font-object in the host, and is a `u32`.
- `Sound` - this is a reference to a loaded sound-object in the host, and is a `u32`.
